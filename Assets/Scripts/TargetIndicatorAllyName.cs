...
public class TargetIndicatorAllyName : MonoBehaviour
{
    ...
    public void InitialiseTargetIndicatorAllyName(GameObject target, Camera mainCamera, Canvas canvas)
    {
        this.target = target;
    ...
    public void UpdateTargetIndicatorAllyName()
    {
